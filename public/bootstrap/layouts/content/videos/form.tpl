                    ...
                    <fieldset>
                        ...
                        <div class="row wrap">
                            <div class="col two-thirds mutableContent wrap">
                                <div id="text-input">
                                    <div id="title-input">
                                        <label>Video URL
                                            <span class="small"> &HorizontalLine; <a href="#">Upload file instead?</a></span>
                                        </label>
                        ...
                        <div class="row">
                            <div class="col sixth  mutableContent"> 
                                <button class="button medium"><?php echo _("Preview Video"); ?></button>

                            </div>                        
                            <div class="col four-sixths">&nbsp;</div>
                            <div class="col sixth" align="right">
                                <button class="button medium"><?php echo _("Publish Video"); ?></button>
                            </div>
